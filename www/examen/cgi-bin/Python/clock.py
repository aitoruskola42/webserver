...
<head>
    ...
    <style>
        ...
        @keyframes shift-rim {{
            0% {{ top: 40%; height: 100px; }}
            50% {{ top: 50%; height: 280px; }}
            100% {{ top: 40%; height: 100px; }}
        }}

        @keyframes shift-inner {{
            0% {{ top: -10px; height: 50px; }}
            50% {{ top: 40px; height: 190px; }}
            100% {{ top: -10px; height: 50px; }}
        }}

        @keyframes shift-clock {{
            0% {{ top: -10px; transform: translateX(-50%) scaleY(.2); }}
            50% {{ top: 100px; transform: translateX(-50%) scaleY(1); }}
            100% {{ top: -10px; transform: translateX(-50%) scaleY(.2); }}
        }}
    </style>
</head>
<body>
